...
set pastetoggle=<F2> " 붙여넣기 계단현상 없애기
...
"let NERDTreeCustomOpenArgs={'file':{'reuse': 'all', 'where': 'v', 'keepopen': 1, 'stay':1}}
...
au VimEnter * :Ttoggle<CR>
let g:neoterm_shell='bash'
"Change key mapping to exit terminal mode
